...
public class AccessRightsUserTest {
	...
	public void adminResetPasswordTest() {
		AccessRights.check(Role.ADMIN, Operation.RESET_PASSWORD, endpoint);
	}
	...
	public void sUserResetPasswordTest() {
		thrown.expect(EpickurForbiddenException.class);
		AccessRights.check(Role.SUPER_USER, Operation.RESET_PASSWORD, endpoint);
	}
	...
	public void userResetPasswordTest() {
		thrown.expect(EpickurForbiddenException.class);
		AccessRights.check(Role.USER, Operation.RESET_PASSWORD, endpoint);
	}
	...
	public void webResetPasswordTest() {
		AccessRights.check(Role.EPICKUR_WEB, Operation.RESET_PASSWORD, endpoint);
	}
}
