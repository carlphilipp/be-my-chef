...
public class AccessRightsCatererTest {
	...
	public void adminReadDishesTest() {
		MatrixAccessRights.check(Role.ADMIN, Operation.READ_DISHES, endpoint);
	}

	@Test
	public void adminPayementInfoTest() {
		MatrixAccessRights.check(Role.ADMIN, Operation.PAYEMENT_INFO, endpoint);
	}
	...
	public void sUserReadDishesTest() {
		MatrixAccessRights.check(Role.SUPER_USER, Operation.READ_DISHES, endpoint);
	}

	@Test
	public void sUserPayementInfoTest() {
		thrown.expect(EpickurForbiddenException.class);
		MatrixAccessRights.check(Role.SUPER_USER, Operation.PAYEMENT_INFO, endpoint);
	}
	...
	public void userReadDishesTest() {
		MatrixAccessRights.check(Role.USER, Operation.READ_DISHES, endpoint);
	}

	@Test
	public void userPayementInfoTest() {
		thrown.expect(EpickurForbiddenException.class);
		MatrixAccessRights.check(Role.USER, Operation.PAYEMENT_INFO, endpoint);
	}
	...
	public void webReadDishesTest() {
		MatrixAccessRights.check(Role.EPICKUR_WEB, Operation.READ_DISHES, endpoint);
	}

	@Test
	public void webPayementInfoTest() {
		thrown.expect(EpickurForbiddenException.class);
		MatrixAccessRights.check(Role.EPICKUR_WEB, Operation.PAYEMENT_INFO, endpoint);
	}
}
